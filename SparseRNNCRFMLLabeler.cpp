...
void Labeler::train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile,
  ...
  m_classifier.init(wordEmb, m_options.wordcontext, m_labelAlphabet.size(), m_options.hiddenSize, m_options.rnnHiddenSize, m_options.rnnLayers, m_featAlphabet.size());
