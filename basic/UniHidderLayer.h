...
public:
  ...
  inline void initial(int nOSize, int nISize, bool bUseB=true, int seed = 0, int funcType = 0) {
   ...
   inline void initial(Tensor<xpu, 2, double> W, Tensor<xpu, 2, double> b,
...
public:
  ...
  inline void ComputeBackwardLoss(Tensor<xpu, 2, double> x, Tensor<xpu, 2, double> y,
		  Tensor<xpu, 2, double> ly, Tensor<xpu, 2, double> lx)
  {
    //_gradW
