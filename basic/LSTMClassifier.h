...
public:
  ...
  inline double process(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      Tensor<xpu, 2, double> lstm_hidden_left_final[seq_size][_rnnMidLayers+1], lstm_hidden_left_finalLoss[seq_size][_rnnMidLayers+1], lstm_hidden_left_finalFLoss[seq_size][_rnnMidLayers+1];
      Tensor<xpu, 2, double> lstm_hidden_left_cell[seq_size][_rnnMidLayers+1], lstm_hidden_left_cellLoss[seq_size][_rnnMidLayers+1], lstm_hidden_left_cellFLoss[seq_size][_rnnMidLayers+1];
      ...
      Tensor<xpu, 2, double> lstm_hidden_right_final[seq_size][_rnnMidLayers+1], lstm_hidden_right_finalLoss[seq_size][_rnnMidLayers+1], lstm_hidden_right_finalFLoss[seq_size][_rnnMidLayers+1];
      Tensor<xpu, 2, double> lstm_hidden_right_cell[seq_size][_rnnMidLayers+1], lstm_hidden_right_cellLoss[seq_size][_rnnMidLayers+1], lstm_hidden_right_cellFLoss[seq_size][_rnnMidLayers+1];
      ...
      for (int idx = 0; idx < seq_size; idx++) {
        ...
        } else
        {
          ...
          _lstm_left_forget.ComputeForwardScore(lstm_hidden_left_final[idx-1][0], lstm_hidden_left_cell[idx-1][0], input[idx], lstm_hidden_left_forget[idx][0]);
          _lstm_left_cell.ComputeForwardScore(lstm_hidden_left_final[idx-1][0], input[idx], lstm_hidden_left_cellcache[idx][0]);
          lstm_hidden_left_cell[idx][0] = lstm_hidden_left_cellcache[idx][0] * lstm_hidden_left_input[idx][0]  + lstm_hidden_left_cell[idx-1][0] * lstm_hidden_left_forget[idx][0];
      ...
      for (int idx = seq_size - 1; idx >= 0; idx--) {
        if (idx == seq_size-1) {
          ...
          _lstm_right_input.ComputeForwardScore(lstm_hidden_right_final[idx+1][0], lstm_hidden_right_cell[idx+1][0], input[idx], lstm_hidden_right_input[idx][0]);
          _lstm_right_forget.ComputeForwardScore(lstm_hidden_right_final[idx+1][0], lstm_hidden_right_cell[idx+1][0], input[idx], lstm_hidden_right_forget[idx][0]);
          _lstm_right_cell.ComputeForwardScore(lstm_hidden_right_final[idx+1][0], input[idx], lstm_hidden_right_cellcache[idx][0]);
          lstm_hidden_right_cell[idx][0] = lstm_hidden_right_cellcache[idx][0] * lstm_hidden_right_input[idx][0]  + lstm_hidden_right_cell[idx+1][0] * lstm_hidden_right_forget[idx][0];
          _lstm_right_output.ComputeForwardScore(lstm_hidden_right_final[idx+1][0], lstm_hidden_right_cell[idx][0], input[idx], lstm_hidden_right_output[idx][0]);
          lstm_hidden_right_finalcache[idx][0] = F<nl_tanh>(lstm_hidden_right_cell[idx][0]);
          lstm_hidden_right_final[idx][0] = lstm_hidden_right_finalcache[idx][0] * lstm_hidden_right_output[idx][0];
        }
      }
      ...
      for (int idLayer = 0; idLayer < _rnnMidLayers; idLayer++) {
        ...
        for (int idx = 0; idx < seq_size; idx++) {
          if (idx == 0) {
            _lstm_middle_left_input[idLayer].ComputeForwardScore(lstm_hidden_null1, lstm_hidden_null2, lstm_hidden_merge[idx][idLayer], lstm_hidden_left_input[idx][idLayer + 1]);
            ...
            _lstm_middle_left_output[idLayer].ComputeForwardScore(lstm_hidden_null1, lstm_hidden_left_cell[idx][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_left_output[idx][idLayer + 1]);
          ...
          {
            _lstm_middle_left_input[idLayer].ComputeForwardScore(lstm_hidden_left_final[idx-1][idLayer + 1], lstm_hidden_left_cell[idx-1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_left_input[idx][idLayer + 1]);
            _lstm_middle_left_forget[idLayer].ComputeForwardScore(lstm_hidden_left_final[idx-1][idLayer + 1], lstm_hidden_left_cell[idx-1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_left_forget[idx][idLayer + 1]);
            _lstm_middle_left_cell[idLayer].ComputeForwardScore(lstm_hidden_left_final[idx-1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_left_cellcache[idx][idLayer + 1]);
            lstm_hidden_left_cell[idx][idLayer + 1] = lstm_hidden_left_cellcache[idx][idLayer + 1] * lstm_hidden_left_input[idx][idLayer + 1]  + lstm_hidden_left_cell[idx-1][idLayer + 1] * lstm_hidden_left_forget[idx][idLayer + 1];
            _lstm_middle_left_output[idLayer].ComputeForwardScore(lstm_hidden_left_final[idx-1][idLayer + 1], lstm_hidden_left_cell[idx][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_left_output[idx][idLayer + 1]);
            lstm_hidden_left_finalcache[idx][idLayer + 1] = F<nl_tanh>(lstm_hidden_left_cell[idx][idLayer + 1]);
            lstm_hidden_left_final[idx][idLayer + 1] = lstm_hidden_left_finalcache[idx][idLayer + 1] * lstm_hidden_left_output[idx][idLayer + 1];
          }
        }
        ...
        for (int idx = seq_size - 1; idx >= 0; idx--) {
          if (idx == seq_size-1) {
            _lstm_middle_right_input[idLayer].ComputeForwardScore(lstm_hidden_null1, lstm_hidden_null2, lstm_hidden_merge[idx][idLayer], lstm_hidden_right_input[idx][idLayer + 1]);
            _lstm_middle_right_cell[idLayer].ComputeForwardScore(lstm_hidden_null1, lstm_hidden_merge[idx][idLayer], lstm_hidden_right_cellcache[idx][idLayer + 1]);
            lstm_hidden_right_cell[idx][idLayer + 1] = lstm_hidden_right_cellcache[idx][idLayer + 1] * lstm_hidden_right_input[idx][idLayer + 1];
            _lstm_middle_right_output[idLayer].ComputeForwardScore(lstm_hidden_null1, lstm_hidden_right_cell[idx][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_right_output[idx][idLayer + 1]);
            ...
            _lstm_middle_right_input[idLayer].ComputeForwardScore(lstm_hidden_right_final[idx+1][idLayer + 1], lstm_hidden_right_cell[idx+1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_right_input[idx][idLayer + 1]);
            _lstm_middle_right_forget[idLayer].ComputeForwardScore(lstm_hidden_right_final[idx+1][idLayer + 1], lstm_hidden_right_cell[idx+1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_right_forget[idx][idLayer + 1]);
            _lstm_middle_right_cell[idLayer].ComputeForwardScore(lstm_hidden_right_final[idx+1][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_right_cellcache[idx][idLayer + 1]);
            lstm_hidden_right_cell[idx][idLayer + 1] = lstm_hidden_right_cellcache[idx][idLayer + 1] * lstm_hidden_right_input[idx][idLayer + 1]  + lstm_hidden_right_cell[idx+1][idLayer + 1] * lstm_hidden_right_forget[idx][idLayer + 1];
            _lstm_middle_right_output[idLayer].ComputeForwardScore(lstm_hidden_right_final[idx+1][idLayer + 1], lstm_hidden_right_cell[idx][idLayer + 1], lstm_hidden_merge[idx][idLayer], lstm_hidden_right_output[idx][idLayer + 1]);
            lstm_hidden_right_finalcache[idx][idLayer + 1] = F<nl_tanh>(lstm_hidden_right_cell[idx][idLayer + 1]);
            lstm_hidden_right_final[idx][idLayer + 1] = lstm_hidden_right_finalcache[idx][idLayer + 1] * lstm_hidden_right_output[idx][idLayer + 1];
          }
        }
      ...
      for (int idx = seq_size - 1; idx >= 0; idx--) {
        ...
        if (idx < seq_size - 1) {
          lstm_hidden_left_cellLoss[idx][0] = lstm_hidden_left_finalcacheLoss[idx][0]
              * (1.0 - lstm_hidden_left_finalcache[idx][0] * lstm_hidden_left_finalcache[idx][0])
              + lstm_hidden_left_cellFLoss[idx][0];
        } else {
          lstm_hidden_left_cellLoss[idx][0] = lstm_hidden_left_finalcacheLoss[idx][0]
              * (1.0 - lstm_hidden_left_finalcache[idx][0] * lstm_hidden_left_finalcache[idx][0]);
        }
        ...
        if (idx == 0) {
          _lstm_left_output.ComputeBackwardLoss(lstm_hidden_null1, lstm_hidden_left_cell[idx][0], input[idx],
              lstm_hidden_left_output[idx][0], lstm_hidden_left_outputLoss[idx][0], lstm_hidden_null1Loss, lstm_hidden_null2Loss,
              inputLossTmp);
          ...
          _lstm_left_cell.ComputeBackwardLoss(lstm_hidden_null1, input[idx],
              lstm_hidden_left_cellcache[idx][0], lstm_hidden_left_cellcacheLoss[idx][0], lstm_hidden_null1Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;

          _lstm_left_input.ComputeBackwardLoss(lstm_hidden_null1, lstm_hidden_null2, input[idx],
              lstm_hidden_left_input[idx][0], lstm_hidden_left_inputLoss[idx][0], lstm_hidden_null1Loss, lstm_hidden_null2Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
        } else {

          _lstm_left_output.ComputeBackwardLoss(lstm_hidden_left_final[idx - 1][0], lstm_hidden_left_cell[idx][0],
              input[idx], lstm_hidden_left_output[idx][0], lstm_hidden_left_outputLoss[idx][0],
              lstm_hidden_null1Loss, lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_left_cellLoss[idx][0] = lstm_hidden_left_cellLoss[idx][0] + lstm_hidden_null2Loss;
          ...
          _lstm_left_cell.ComputeBackwardLoss(lstm_hidden_left_final[idx - 1][0], input[idx],
              lstm_hidden_left_cellcache[idx][0], lstm_hidden_left_cellcacheLoss[idx][0], lstm_hidden_null1Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_left_finalFLoss[idx - 1][0] = lstm_hidden_left_finalFLoss[idx - 1][0] + lstm_hidden_null1Loss;

          _lstm_left_forget.ComputeBackwardLoss(lstm_hidden_left_final[idx - 1][0], lstm_hidden_left_cell[idx - 1][0],
              input[idx], lstm_hidden_left_forget[idx][0], lstm_hidden_left_forgetLoss[idx][0],
              lstm_hidden_null1Loss, lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_left_cellFLoss[idx - 1][0] = lstm_hidden_left_cellFLoss[idx - 1][0] + lstm_hidden_null2Loss;
          lstm_hidden_left_finalFLoss[idx - 1][0] = lstm_hidden_left_finalFLoss[idx - 1][0] + lstm_hidden_null1Loss;

          _lstm_left_input.ComputeBackwardLoss(lstm_hidden_left_final[idx - 1][0], lstm_hidden_left_cell[idx - 1][0],
              input[idx], lstm_hidden_left_input[idx][0], lstm_hidden_left_inputLoss[idx][0], lstm_hidden_null1Loss,
              lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_left_cellFLoss[idx - 1][0] = lstm_hidden_left_cellFLoss[idx - 1][0] + lstm_hidden_null2Loss;
          lstm_hidden_left_finalFLoss[idx - 1][0] = lstm_hidden_left_finalFLoss[idx - 1][0] + lstm_hidden_null1Loss;
        }
      ...
      for (int idx = 0; idx < seq_size; idx++) {
        ...
        if (idx > 0) {
          lstm_hidden_right_cellLoss[idx][0] = lstm_hidden_right_finalcacheLoss[idx][0]
              * (1.0 - lstm_hidden_right_finalcache[idx][0] * lstm_hidden_right_finalcache[idx][0])
              + lstm_hidden_right_cellFLoss[idx][0];
        } else {
          lstm_hidden_right_cellLoss[idx][0] = lstm_hidden_right_finalcacheLoss[idx][0]
              * (1.0 - lstm_hidden_right_finalcache[idx][0] * lstm_hidden_right_finalcache[idx][0]);
        }
        ...
        if (idx == seq_size - 1) {
          _lstm_right_output.ComputeBackwardLoss(lstm_hidden_null1, lstm_hidden_right_cell[idx][0], input[idx],
              lstm_hidden_right_output[idx][0], lstm_hidden_right_outputLoss[idx][0], lstm_hidden_null1Loss, lstm_hidden_null2Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          ...
          _lstm_right_cell.ComputeBackwardLoss(lstm_hidden_null1, input[idx],
              lstm_hidden_right_cellcache[idx][0], lstm_hidden_right_cellcacheLoss[idx][0], lstm_hidden_null1Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;

          _lstm_right_input.ComputeBackwardLoss(lstm_hidden_null1, lstm_hidden_null2, input[idx],
              lstm_hidden_right_input[idx][0], lstm_hidden_right_inputLoss[idx][0], lstm_hidden_null1Loss, lstm_hidden_null2Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
        } else {
          _lstm_right_output.ComputeBackwardLoss(lstm_hidden_right_final[idx + 1][0], lstm_hidden_right_cell[idx][0],
              input[idx], lstm_hidden_right_output[idx][0], lstm_hidden_right_outputLoss[idx][0],
              lstm_hidden_null1Loss, lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_right_cellLoss[idx][0] = lstm_hidden_right_cellLoss[idx][0] + lstm_hidden_null2Loss;
          ...
          _lstm_right_cell.ComputeBackwardLoss(lstm_hidden_right_final[idx + 1][0], input[idx],
              lstm_hidden_right_cellcache[idx][0], lstm_hidden_right_cellcacheLoss[idx][0], lstm_hidden_null1Loss,
              inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_right_finalFLoss[idx + 1][0] = lstm_hidden_right_finalFLoss[idx + 1][0] + lstm_hidden_null1Loss;

          _lstm_right_forget.ComputeBackwardLoss(lstm_hidden_right_final[idx + 1][0], lstm_hidden_right_cell[idx + 1][0],
              input[idx], lstm_hidden_right_forget[idx][0], lstm_hidden_right_forgetLoss[idx][0],
              lstm_hidden_null1Loss, lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_right_cellFLoss[idx + 1][0] = lstm_hidden_right_cellFLoss[idx + 1][0] + lstm_hidden_null2Loss;
          lstm_hidden_right_finalFLoss[idx + 1][0] = lstm_hidden_right_finalFLoss[idx + 1][0] + lstm_hidden_null1Loss;

          _lstm_right_input.ComputeBackwardLoss(lstm_hidden_right_final[idx + 1][0], lstm_hidden_right_cell[idx + 1][0],
              input[idx], lstm_hidden_right_input[idx][0], lstm_hidden_right_inputLoss[idx][0],
              lstm_hidden_null1Loss, lstm_hidden_null2Loss, inputLossTmp);
          inputLoss[idx] = inputLoss[idx] + inputLossTmp;
          lstm_hidden_right_cellFLoss[idx + 1][0] = lstm_hidden_right_cellFLoss[idx + 1][0] + lstm_hidden_null2Loss;
          lstm_hidden_right_finalFLoss[idx + 1][0] = lstm_hidden_right_finalFLoss[idx + 1][0] + lstm_hidden_null1Loss;
  ...
  void checkgrads(const vector<Example>& examples, int iter) {
    ...
    for (int idLayer = 0; idLayer < _rnnMidLayers; idLayer++) {
      ...
      checkgrad(examples, _lstm_middle_left_input[idLayer]._W1, _lstm_middle_left_input[idLayer]._gradW1, "_lstm_middle_left_input"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_left_input[idLayer]._W2, _lstm_middle_left_input[idLayer]._gradW2, "_lstm_middle_left_input"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_left_input[idLayer]._W3, _lstm_middle_left_input[idLayer]._gradW3, "_lstm_middle_left_input"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_left_input[idLayer]._b, _lstm_middle_left_input[idLayer]._gradb, "_lstm_middle_left_input"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_left_output[idLayer]._W1, _lstm_middle_left_output[idLayer]._gradW1, "_lstm_middle_left_output"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_left_output[idLayer]._W2, _lstm_middle_left_output[idLayer]._gradW2, "_lstm_middle_left_output"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_left_output[idLayer]._W3, _lstm_middle_left_output[idLayer]._gradW3, "_lstm_middle_left_output"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_left_output[idLayer]._b, _lstm_middle_left_output[idLayer]._gradb, "_lstm_middle_left_output"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_left_forget[idLayer]._W1, _lstm_middle_left_forget[idLayer]._gradW1, "_lstm_middle_left_forget"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_left_forget[idLayer]._W2, _lstm_middle_left_forget[idLayer]._gradW2, "_lstm_middle_left_forget"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_left_forget[idLayer]._W3, _lstm_middle_left_forget[idLayer]._gradW3, "_lstm_middle_left_forget"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_left_forget[idLayer]._b, _lstm_middle_left_forget[idLayer]._gradb, "_lstm_middle_left_forget"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_left_cell[idLayer]._WL, _lstm_middle_left_cell[idLayer]._gradWL, "_lstm_middle_left_cell"+ssposition.str()+"._WL", iter);
      checkgrad(examples, _lstm_middle_left_cell[idLayer]._WR, _lstm_middle_left_cell[idLayer]._gradWR, "_lstm_middle_left_cell"+ssposition.str()+"._WR", iter);
      checkgrad(examples, _lstm_middle_left_cell[idLayer]._b, _lstm_middle_left_cell[idLayer]._gradb, "_lstm_middle_left_cell"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_right_input[idLayer]._W1, _lstm_middle_right_input[idLayer]._gradW1, "_lstm_middle_right_input"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_right_input[idLayer]._W2, _lstm_middle_right_input[idLayer]._gradW2, "_lstm_middle_right_input"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_right_input[idLayer]._W3, _lstm_middle_right_input[idLayer]._gradW3, "_lstm_middle_right_input"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_right_input[idLayer]._b, _lstm_middle_right_input[idLayer]._gradb, "_lstm_middle_right_input"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_right_output[idLayer]._W1, _lstm_middle_right_output[idLayer]._gradW1, "_lstm_middle_right_output"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_right_output[idLayer]._W2, _lstm_middle_right_output[idLayer]._gradW2, "_lstm_middle_right_output"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_right_output[idLayer]._W3, _lstm_middle_right_output[idLayer]._gradW3, "_lstm_middle_right_output"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_right_output[idLayer]._b, _lstm_middle_right_output[idLayer]._gradb, "_lstm_middle_right_output"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_right_forget[idLayer]._W1, _lstm_middle_right_forget[idLayer]._gradW1, "_lstm_middle_right_forget"+ssposition.str()+"._W1", iter);
      checkgrad(examples, _lstm_middle_right_forget[idLayer]._W2, _lstm_middle_right_forget[idLayer]._gradW2, "_lstm_middle_right_forget"+ssposition.str()+"._W2", iter);
      checkgrad(examples, _lstm_middle_right_forget[idLayer]._W3, _lstm_middle_right_forget[idLayer]._gradW3, "_lstm_middle_right_forget"+ssposition.str()+"._W3", iter);
      checkgrad(examples, _lstm_middle_right_forget[idLayer]._b, _lstm_middle_right_forget[idLayer]._gradb, "_lstm_middle_right_forget"+ssposition.str()+"._b", iter);

      checkgrad(examples, _lstm_middle_right_cell[idLayer]._WL, _lstm_middle_right_cell[idLayer]._gradWL, "_lstm_middle_right_cell"+ssposition.str()+"._WL", iter);
      checkgrad(examples, _lstm_middle_right_cell[idLayer]._WR, _lstm_middle_right_cell[idLayer]._gradWR, "_lstm_middle_right_cell"+ssposition.str()+"._WR", iter);
      checkgrad(examples, _lstm_middle_right_cell[idLayer]._b, _lstm_middle_right_cell[idLayer]._gradb, "_lstm_middle_right_cell"+ssposition.str()+"._b", iter);
    }
